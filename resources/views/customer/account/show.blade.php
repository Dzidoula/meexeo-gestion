<x-layouts.public title="Mon compte — SONOR LOCATION">
    <div class="mx-auto max-w-2xl px-6 py-12">
        ...
        <div class="mt-6 p-6" style="border-radius:var(--radius-sonor);background:var(--color-sonor-surface);box-shadow:var(--shadow-sonor-card)">
            ...
            <form method="POST" action="{{ route('customer.logout') }}" class="mt-6 border-t pt-6" style="border-color:var(--color-sonor-border)">
                @csrf
